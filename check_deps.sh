...
VUEJS_LIB_EXCLUDE="@apollo/client mock-apollo-client @vueuse/core @unhead/vue tailwindcss @oruga-ui/oruga-next @oruga-ui/theme-oruga @types/leaflet.locatecontrol @eslint/js eslint vite vue-router typescript"
