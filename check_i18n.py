...
not_translated = set(expected_i18n_keys) - set(keys_translated)
print("I18n not translated = %d" % len(not_translated))
print("Missing keys:", sorted(not_translated))
print("I18n not used = %d"  % (len(set(keys_translated) - set(expected_i18n_keys))))
sys.exit(0 if len(not_translated) == 0 else 1)